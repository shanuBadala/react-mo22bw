      ...
      <div className="left-pane">
        <div className="container">
          ...
          <div className="action-block">
            <button className={that.state.removeMode ? "button-primary disabled" : "button-primary"} onClick={this.addQuestion}><i className="material-icons"></i> ADD QUESTION</button>
            <button className={that.state.removeMode ? "remove-button-active" : ""} onClick={this.toggleRemoveMode}><i className="material-icons"></i> {that.state.removeMode ? "DONE REMOVING" : "REMOVE QUESTIONS"}</button>
          </div>
        </div>
      </div>
    )
